...
app.get('*', function(req, res) {
    res.redirect('https://wa2.othellobeauty.com'); //ganti dengan url domain Anda
});
...
const db = mysql.createConnection({
  host: 'localhost',
  user: 'triharto_wa2',
  password: 'grobogan230999',
  database: 'triharto_wa2'
});
...
const configs = {
    ...
    url_callback : 'https://wa2.othellobeauty.com/helper/callback.php'
};
// cronjob
